<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="KobsisSiparisTakip.Web.AdminLogin" %>
    ...
    <form id="FormLogin" runat="server" defaultbutton="LB_Login">
        ...
        <table style="width: 100%">
            ...
            <tr style="display: none">
             ...
             <tr>
                <td>
                    <telerik:RadDropDownList ID="ddlMusteri" runat="server" RenderMode="Lightweight"></telerik:RadDropDownList>
                </td>
            </tr>
            <tr>
